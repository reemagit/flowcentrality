...
#======================================================================================
def diamond_iteration_of_first_X_nodes(G,S,X,alpha, progress_bar=True):
    ...
    while len(added_nodes) < X:    
        ...
        # ------------------------------------------------------------------
        if progress_bar:
            if len(added_nodes) > prev_len:
                prog.update(len(added_nodes)-prev_len)
                prev_len=len(added_nodes)
        info = {}
...
# 
# ===========================================================================
def DIAMOnD(G_original,seed_genes,max_number_of_added_nodes,alpha,outfile = None, progress_bar=True):
    ...
    added_nodes = diamond_iteration_of_first_X_nodes(G_original,
                                                     disease_genes,
                                                     max_number_of_added_nodes,alpha, progress_bar=progress_bar)
