...
parser = argparse.ArgumentParser(description='Plot coexpression scores for GSE4302')
...
if args.out_file is None:
    out_file = '../gendata/plots/GSE4302_boxplot.pdf'
else:
...
plt.title('SC in Asthmatic samples (' + gseid + ')',fontsize=12, pad=10)
plt.tight_layout()
