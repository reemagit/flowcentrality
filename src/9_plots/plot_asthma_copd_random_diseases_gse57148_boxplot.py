...
obs_disease = non_nan(np.loadtxt('../gendata/coexpression/GSE57148/seqcorrs_disease_gsms_1000.dat'))
...
labels = ['COPD-'+utils.trim_text(lbl,20) for lbl in disNames_disease_sort][:N_max]
...
a0.set_xticks([])
a0.set_ylabel('-log(p-val)', fontsize=10, labelpad=18)
a0.spines['right'].set_visible(False)
a0.spines['top'].set_visible(False)
a0.set_title('SC in COPD samples (GSE57148)',fontsize=14)
