...
def main(args):
    ...
    gse = GEOparse.get_GEO(geo='GSE4302', destdir=join(args.out_expr_dir,'raw'))
    ...
    disease_cls = ['sample type: Asthmatic at baseline', 'sample type: Asthmatic after Flovent',
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Process GSE4302')
